%\section{
	Tests écoute Tomatis\textsuperscript \textregistered, suite et fin:
	\\
...
%, sauf pour un contre-exemple (Patient F/ GC) dont nous donnerons plus d'explication un peu plus loin 
%(sous le Ch. Résultat, p. 71).
...
%                                 
  ...
  %                                est-ce que ça va dans le bon sens? }
   ...
   parallèle au questionnaire WHOQOL.
    ...
    \end{figure}
    \clearpage
    %Comparatif des résultats entre WHOQO
...
\end{figure}
   ...
   Il existe plusieurs hypothèses. %il se peut que l
   ...
   % et l
     ...
     patient a %reçu de brèves explications 
  %sur le possible impact des séances de musicothérapie; la réaction du patienta été immédiate, 
 ...
 % Comment expliquer autrement ses  réactions? le 1°test aussi tôt fait, il a bombardé le thérapeute de 
 %questions puis s'est précipité dans sa 
  %chambre pour écouter en veux-tu en voilà de la musique, avec la certitude que l'écoute de la 
  %musique  aura un effet sur lui. 
...
%\part{title} 
 ...
 % utilisation s'est faite dans un contexte pour lequel il n'a pas été conçu.
  % Les conditions d'utilisation ici ne sont pas conformes à Tomatis car
  % L'évolution de l'écoute dans la méthode Tomatis suppose 2h d'écoute par jour pendant 15 jours 
  %consécutifs. 
  %En ayant conscience des limites énoncées, nous pouvons tenir compte de toutes les données 
  %d'observation récoltées.% avec celles des séances en musicothérapie et des entrevues.
    \\
     Nous spécifions 
...
%musicothérapie, les entrevues ainsi que sur la quantification du ressenti subjectif de la qualité de vie au 
%moyen du 
%questionnaire WHOQOL, effectué deux fois, en début et fin de séjour en clinique.
 \\
...
\begin{itemize}
	...
	%Une musicothérapie ciblée sur l'écoute  est-elle en lien avec une modification de la qualité 
	%d'écoute 
	%mesurable par le test d'écoute Tomatis\textsuperscript \textregistered ?
...
\end{itemize}
 ...
 %, résultats correspondants à ceux recueillis par  %au ressenti subjectif 
...
%Mais il n'a pas été possible de faire la corrélation avec les résultats du questionnaire WHOQOL, puisqu
 ...
 Notre intérêt s'est centré sur l'analyse d'
  ...
  \begin{itemize}
       ...
       d'écoute Tomatis\textsuperscript \textregistered?
      %Une musicothérapie ciblée sur l'écoute  est-elle en lien avec une modification de la qualité 
       %d'écoute mesurable par le test d'écoute Tomatis\textsuperscript \textregistered?
        \\
...
%t,
 ...
 centrer essentiellement sur un travail rythmique.  
    \\
    %avec des exercices précis 
 %appliqués à chaque patient. 
 ...
 %  Ceci nous amène à considérer  l'anamnèse et le bilan en musicothérapie.
  ...
  spécifiquement axé sur le son, par conséquent  musicothérapeutique. 
  	...
  	% comme le relève Gindl \autocite{gindl} sur
  ...
  %%l'alliance thérapeutique est claire.
  ...
  %Ce qui nous permet de rejoindre l'avis de  Lutz
  %Hochreutener\autocite {lutz_hochreutener_spiel_2009} 
 ...
 % de rejoindre le patient dans son univers pour l'aider à se retrouver et  communiquer.
  ...
  %est un moyen complémentaire, se confirmant dans une 
  %évaluation plus précise de l'utilisation d'outils variés, en obtenant des repères et une optique 
  %différente 
  %au sujet du parcours effectué et à
 %construire.
% dans la façon d'aborder un travail en musicothérapie.
 % \newline 
 ...
 %plus qu'aux rythmes, à titre d'exemple.
   ...
   WHOQOL. 
   %Une amélioration du tracé des courbes d'écoute allant dans la tendance d'une courbe 
   %harmonieuse en 
 ...
 prouver.
  %il y  a, par un autre biais, peut-être une ébauche de sa transformation mise en lumière de façon 
  %originale  par sa capacité d' écoute. 
  %Le dialogue, lors de l'issue du test final, provoquera souvent un autre 
...
% , indépendamment du groupe testé. On peut donc supposer que le séjour clinique a un impact sur le 
%patient d'un point de vue écoute.
 \newline 
...
% outil de sensibilisation à certains problèmes de surdité. Il en est de même avec la détection de 
%distorsion:
...
%ainsi que d'une analysesuivie d'une généralisation partielle, 
...
%  et moins surl'auto-évaluation par questionnaires. 
%Globalement, le petit nombre de patients évalués ne correspond pas aux critères d'une étude 
%scientifique. 
\\
...
%De plus, ce test n'est pas réalisable par les musicothérapeutes sans formation Tomatis.
\\
...
%Nous pouvons par contre tenir compte de toutes les 
...
%A l'inverse, ces séances  auraient pu être très ciblées sur l'écoute et élaborées de façon systématique.
\\
...
l'oreille dans sa capacité d'écoute. % qui "..est l'organe le plus sensible des
...
%l'univers''}} \autocite{delbaz_recherche_2016}\footnote{David Delbaz, astrophysicien, chef de 
%laboratoire 
%au CEA et Alain
