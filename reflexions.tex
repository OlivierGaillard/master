...
% \textbf { Patient F.:}
 ...
 \begin{figure}[th]
 	...
 	\caption[Patient Le : 1° test]{GC: Premier test Le}
 	\label{fig:moyavle}
 \end{figure}
  \begin{figure}[th]
 	\centering
 	\includegraphics[width=1\linewidth]{images/graphiques/moyaprLE.png}
 	\caption[Patient Le : 2° test]{GC: Deuxième test Le}
 	\label{fig:moyaprle}
 \end{figure}
 %\paragraph
 %\textbf{Patient MAI: 
  \begin{figure}[th]
 	...
 	\caption[Patient Mai : 1° test]{GC: Premier test Mai}
 	\label{fig:moyavmai}
 	 \end{figure}
  ...
  \begin{figure}[th]
 	...
 	\caption[Patient Mai: 2° test]{GC: Deuxième test Mai}
 	\label{fig:moyaprmai}
 \end{figure}
 % \paragraph
% {Patient HU:}
 \begin{figure}[th]
 	...
 	\caption[Patient Hu : 1° test]{GC: Premier test Hu}
 	\label{fig:moyavhu}
 \end{figure}
  \begin{figure}[th]
 	\centering
 	\includegraphics[width=1\linewidth]{images/graphiques/moyaprHU}
 	\caption[Patient Hu : 2° test]{GC: Deuxième test Hu}
 	\label{fig:moyaprhu}
 \end{figure}
...
% \paragraph{ Patients musico}
 ...
 \begin{figure}[th]
 	...
 	\caption[Patient Mu : 2° test]{GM: Second test Mu}
 	\label{fig:moyaprmu}
 \end{figure}
...
% (pas de WOQOL fin de séjour)
 ...
 \begin{figure}[th]
 	...
 	\caption[Patient K. . 1° test]{GM: Premier test K.}
 ...
 \begin{figure}[th]
 	...
 	\caption[Patient K. : 2° test]{GM: Second test K.}
...
\chapter{Discussion}
\label{Conclusions}
\section{Synthèse des résultats : l'impact des différences d'écoute }
Est-ce que l'écoute est impactée ou non par la musicothérapie?
...
Il s'agissait  de vérifier si l'écoute s'est transformée par la musicothérapie et ainsi 
