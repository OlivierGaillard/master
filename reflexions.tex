...
\begin{itemize}
  \item la création d' une alliance thérapeutique et
     travail avec le son avec l'implication directe du
     patient dans le rôle de la 
     reconnaissance de sons
 \item      Il comporte un travail immédiat avec le son en impliquant le patient
 ...
 sons émis par l'appareil et transmis aux écouteurs en les repérant
  ...
  \item Cette implication directe conduit le patient à créer par lui-même et de manière
 inconsciente  
...
\item Il peut être perçu comme un cadre médical  rassurant par nombre de patients, jouant son rôle de soutien dans la prise en charge.
  
 
\item En cours de la thérapie, il peut être utile d'évaluer, tout
...
\item En fin de thérapie, il permet d'évaluer la transformation.
