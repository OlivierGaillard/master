...
\begin{description}
\item[Entendre] percevoir des sons, saisir par l'ouïe
\item[Ecouter] trois sens: 
\begin{enumerate}
...
forme de décodage : Il s'agit d'un acte, d'une action, d'une capacité. 
...
Entendre et écouter sont donc des processus bien différents «deux
...
de même pour entendre et écouter. L'écoute résulte
du vouloir entendre et est l'équivalent de la visée.'' % là je ne sais pas ce appartient à la citation.
...
de l'Université de Rouen n\textdegree 215, \cite{Nevjinsky1996}.} La consigne évolue de l'identification de sons à l'association libre
