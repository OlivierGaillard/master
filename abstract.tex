...
\begin{abstract}
	...
	\begin{french}	
L'axe principal porte sur l'observation de la capacité d'écoute des patients %en conclusion d'un suivi 
 après un suivi individuel en musicothérapie de trois semaines en clinique.
Le test d'écoute Tomatis,\textsuperscript \textregistered le questionnaire WHOQOL sur la qualité de vie 
%et l'observation des séances
 sont les moyens 
%utilisés 
pour collecter des données comparatives. 
%différentielles entre deux groupes di
%pour synthétiser les différences
 ...
 six au groupe
 musicothérapie (GM), sept au groupe contrôle (GC).
 % Le WHOQOL est rempli avant et 
 %après séjour afin d'évaluer leur état psychique.
L'analyse comparative des résultats révèle une amélioration de la qualité de vie et une modification 
positive et significative 
de la capacité d'écoute après le suivi en musicothérapie  %par le 
%test 
%d'écoute 
%Tomatis
 pour GM contrairement à GC, résultats correspondants au   %au 
 %ressenti subjectif 
...
%négatif.
En conclusion,  le test d'écoute 
Tomatis\textsuperscript \textregistered pourrait représenter un outil d'évaluation intéressant et le suivi en 
musicothérapie aurait possiblement %nfluencé positivement la façon d'écouter 
%%%
un impact positif autant sur la qualité de vie  du patient que sur sa qualité d'écoute.
Vue la taille réduite des échantillons et  en dépit d'une plus ample dimension 
statistique,  ce travail avantagera plus les aspects qualitatifs que quantitatifs. 
%corrélée à l'état psychique mis en évidence par le WHOQOL.
%La totalité des questionnaires WHOQOL demeure toutefois 
%inférieure à ce qui avait été initialement planifié, donc sans dimension statistique,   %en dépit d'une plus 
%ample dimension statistique, ce 
%d'être 
...
results 
corresponding to those re-collected by the WHOQOL questionnaire. In conclusion, an individual 
follow-up in music therapy would 
possibly  
have a positive impact on both the quality of listening and the quality of life of the patient. However, the 
