...
et l'observation des séances/ entretiens sont les moyens 
utilisés pour collecter des données comparatives. 
...
de la capacité d'écoute après musicothérapie  %par le 
%test 
%d'écoute 
%Tomatis
 pour GM contrairement à GC, résultats correspondants  à ceux recueillis par les séances et   %au 
 %ressenti subjectif 
...
eu un impact positif autant sur la qualité de vie  du patient que sur sa qualité d'écoute. Le test d'écoute 
Tomatis\textsuperscript \textregistered pourrait représenter un outil d'évaluation intéressant.
