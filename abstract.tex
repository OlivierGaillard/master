...
Un test d'écoute pourrait avoir un sens pour un patient pour plusieurs raisons. Dans notre monde d'uniformisation, il est intéressant  de pouvoir réaliser et constater l'aspect très personnel de notre écoute sous le couvert d'un test commun. Notre écoute est  individuelle et non standardisée à des normes physiques de celle-ci.
