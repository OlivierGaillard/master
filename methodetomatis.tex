\chapter{Tomatis A. 1920-2001: l'essentiel de son approche}
...
Spécialiste en neurophysiologie auditive, il a étudié la relation
existant entre l'oreille et la voix, et par extension entre l'écoute
et la communication en créant 
une nouvelle discipline, l'audio-psycho-phonologie avec des
découvertes  qui furent établies au
...
Sa méthode est une pédagogie et une
thérapie de l'écoute. L'outil est un appareil électronique appelé
...
sensoriel} , et par conséquent la communication. 
...
Elle regroupe trois disciplines, successivement,
...
pour motivation première, l'application clinique de ses recherches. Très intuitif et remettant en question
les 
théories appliquées, il savait créer des liens entres les
disciplines.
En soignant
des chanteurs à la voix déficiente, il a eu l'idée de leur tester
leur audition et ainsi détecter des correspondances avec leurs difficultés
vocales. 
...
Comme nous l'avons spécifié en annexe sur l'anatomie de l'oreille, les sons font vibrer le tympan 
qui,
...
Voyons plus en détail la conduction osseuse:
