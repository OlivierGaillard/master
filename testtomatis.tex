...
graphique de l'écoute, il permet d'en objectiver la qualité. Ceci est un complément de ce qui a été déjà cité plus haut. \footnote{Alfred Tomatis et le test d'écoute, cf.Chap.3.2.1 p.20}
...
\footcite{lemonde.fr:stradivarius}.
