...
Tomatis, qui fera l'objet de mon travail.
...
graphique ci-dessous,(Fig 5.3) les paramètres du\textbf{ seuil}, de la
...
caractéristique auditive. Cette dernière permet de donner des informations sur la
qualité d'écoute, touche aux aspects  linguistiques (conscience
...
On considère d'abord l'allure générale des courbes, leur dessin, la forme, l' équilibre, la symétrie  : 
puis on estime
...
Une courbe est définie comme harmonieuse si elle ne comporte pas de
pics, de scotomes 
qui laisseraient
