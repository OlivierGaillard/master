...
\textbf{L'existence de difficultés de perception dans les zones nous
	...
	test d'écoute.} Pour une optimalisation de l'écoute différenciée, afin de s'ajuster à la \textbf{capacité 
	d'écoute de base} 
...
\textbf{ les trois zones du
	test d'écoute avec des données musicothérapeutiques et des associations psychologiques}. Nous 
	l'avons illustré avec les figures 3.11 et 3.12.  Ce ne 
	sont que des suggestions dans une perspective d'analyse 
plus
poussée et, à notre humble avis, fort intéressante, car notre formation de base est musicienne et 
musicothérapeute et non psychologue.
...
Ces chiffres, issus d'un constat personnel de notre recherche par souci d'exactitude, se sont nettement
modifiés et tendent vers
ceux dits ``idéaux''  qui équivalent aux environs de 1,3 pour
C. A. et 3,1 pour 
C. O.\footnote{ hors de toutes données ou directives Tomatis}. L'écart reste cependant très important. % 
%A
