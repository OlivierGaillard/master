...
Puisque la racine du mot `écouter'signifirait aussi \emph{partager}, nous
 remarquerons alors à juste titre que nous nous écoutons souvent et
 parfois trop! mais surtout que nous écoutons le plus souvent en
 face de quelqu'un ou par la lecture d'un livre avec cette volonté et
 le 
 désir de
 comprendre et de rentrer en contact avec l'autre, comme la voix de  l'écrivain qui
...
article d'une 
étude franco-américaine scientifique% quelle année?
...
\textbf{sélectivité }comme ``mécanisme de défense''.\footnote{S.Freud,
  Psychologie de la vie quotidienne, 1904, Poche, Petite Biblio Payot,
  Tome 11}
...
sur la formation réticulée, cl glossaire
...
Nous pouvons aussi citer les recherches telles faites avec la reconnaissance de
...
``La voix est la
      résultante de la pensée \textbf{résonnante}  et raisonnante''.\footnote{J.Bonhomme, musicothérapeute, formateur 
...
l'affect proprement auriculaire''\autocite[ch. 13]{auriol:cle}.
...
mentionné dans le dictionnaire de psychologie.\autocite[298]{doronparot}%\footnote{Doron et Parot, rétroaction;
...
Ainsi la façon d'émettre un son, le timbre de la voix, la fluidité
verbale sont des
éléments clairement significatifs et dans le contexte de ce travail,
que nous approfondirons un peu plus au Ch.4.4.