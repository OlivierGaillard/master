...
cerveau) de Rizzolati G. (1990) \autocite[118--119]{van_eersel_cerveau} \footnote{"Notre cerveau n'a pas fini de nous étonner", Entretien avec Jean-Michel 
...
Une autre étude du CNRS \autocite{affectiveDisorders}\footnote{``Les seuils auditifs des sons purs 
...
\label{musicothEtpsycho}
	 ...
	 La musique s'est révélée ainsi être un important support
         d'expérimentation.
	 R. Benenzon, J. Verdeau-Paillès, E.
  ...
  \subsection{Benenzon Rolando Omar} 
    ...
    musicien argentin, Buenos Aires} (1939).
	  ...
	  de Jung, mais s'imprégnant de même de Freud, Winnicott
          (1953, concept d'\textit{objet transitionnel}),\footnote{D. W. Winnicott: ``Jeu et réalité'', Gallimard 1975} Watzlawick.\footnote{ Watzlawick Paul, 1921-2007  théoricien dans la théorie de la communication et le constructivisme radical, membre fondateur de l'École de Palo Alto, psychologue, psychothérapeute, psychanalyste jungien et sociologue} 
...
contenu extériosé, activant aussi l'aspect artistique.\footnote{ \textit{La « troisième oreille » et la pensée musicale}, édition Fuzeau, Paris, 2005.
\textit{Le bilan psycho-musical et la personnalité}, édition Fuzeau, Paris, 3e édition revue et augmentée, 2005.
...
conscient à l'inconscient.\footnote{\textsl{The Evolution of Guided Imagery and Music}, 
 ...
 %%%*,
Abraham Maslow \footnote{A. Maslow\textit{  The Farther reaches of human natur}, Londres, Penguin
...
\textit{``La voix est la
  	...
  	en expression vocale, musicien, auteur de \textit{``La voix énergie,
...
travaux d'Alfred Tomatis, avec lequel il s'est formé.
...
d'imaginaire et de symbolisme, ainsi que  \textsf{\textit{``la matérialité insaisissable
  des vibrations qui empruntent  les voies mystérieuses de
l'affect proprement auriculaire''}
(Lacan)}\autocite[ch. 13]{auriol:cle}.
...
et comparables entre eux.\footnote{ Auteurs: K.Schumacher,
  Cl.Calvet, S.Reiner,''EBQ und seine Entwicklungspsychologien
  Grundlagen'' Ed. Vanderhoeck-Ruprecht, 2011 }
