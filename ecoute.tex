...
et sur la
découverte du rôle mimétique des neurones miroir ( ``troisième''
...
De même l'étude réalisée avec Aubert-Khalfa, Granier \& Reynaud et al., faite
...
traumatisants sur l'audition, impliquant des conséquences dépressives \autocite{affectiveDisorders}:
...
En effet, selon Williams, Teasdal \& Segal et al.,  l'écoute peut être fragilisée, modifiée, distordue, 
appliquant une sélection de sons par la mise en 
...
incontrôlable \autocite {harrisson_autisme_2017}\footnote{Cet ouvrage propose une description unique 
du TSA
...
directe et significative entre les systèmes auditif et
         ...
         ``interpersonnelle'',\enquote{interpersonnelle
...
tests de 
sons purs, le tracé rouge correspond à l'oreille droit et la bleue à la gauche) 
...
\begin{figure}
	...
	\caption{Exemple d'audiogramme, Amplifion SA, 2008}
\label{audiogramme}
\end{figure}
...
ci-dessus %\ref{morceauxDeMusique} 
représente  
...
\\
Dans le schéma ci-dessus (Fig. 3.3.) est représenté l'Oreille Electronique
