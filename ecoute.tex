...
Voici l'illustration concrète par un test
...
strychnine) se révélait inadéquat et impossible à accorder comme les
cordes d'un violon.
\paragraph  Jaillit alors l'\textit{hypothèse fondatrice }
que la perturbation de la voix n'était pas due à un défaut des cordes
vocales, mais à une altération du fonctionnement de l'oreille d'où l'idée
d'une correction perceptive à l'aide d'un appareil électronique (Oreille
Electronique, appareil à ``effet Tomatis'').
\footnote{cf.glossaire} en imposant à l'oreille
