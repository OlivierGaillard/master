...
l'aide de son 
appareil spécifique, il
semble plus objectif et plus neutre. Il se 
fait au début et en fin de thérapie, apportant donc plus 
d'éléments comparatifs  
entre le bilan initial et final. 
Nous allons voir s'il se différencie vraiment des autres, si cette 
objectivité est réellement possible ainsi que  la valeur qu'il représente.
%et sur quels points.
