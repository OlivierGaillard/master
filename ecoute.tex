...
Mozart, Rachmaninov ou Vivaldi.)
 ...
 \subsection{ NEVJINSKY Fern (psychanalyste, Paris)}
 
 De son côté, Fern Nevjinsky a développé à partir du  test de
 Rorschach *(glossaire:  tests projectifs, selon Doron et Parot, par
 D.Anzieu) dès 1989 un test psycho-musical avec des morceaux
...
du bilan psycho-musical.
  ...
  \subsection{ BONHOMME Jacques (musicien, musicothérapeute, France)} \footnote{J.Bonhomme, musicothérapeute, formateur 
  	en expression vocale, musicien, auteur de ``La voix énergie,
...
d'écoute, inspirés de ceux d'A. Tomatis.
 \chapter{TOMATIS Alfred (1921-2001,médecin oto-rhino-laryngologue,
   spécialiste en neurophysiologie auditive)}      
