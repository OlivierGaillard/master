...
`Entendre', c'est  percevoir des sons, saisir par l'ouïe, tandis qu'avec
`écouter', on prête l'oreille à, on s'applique à entendre, on fait attention, on suit un avis, et \emph{au figuré}, on suit une impulsion, une inspiration.
...
\textit{``clairaudience"}, (faculté d'audition paranormale) semble-t-il, selon Didier
...
Car nous pouvons aussi différencier des différents types d'écoute. D'après Edith Lecourt \autocite [p. 182] {lecourt:decouvrir},
...
on en distingue plusieurs : l'écoute verbale, musicale, plurivocale et multiple.
 ...
 particulier, de ``grâce"  nommé ``le concept d'illusion groupale" d'après Anzieu \autocite{anzieu:groupal},
...
\subsection{La perception des sons et l'existence de troubles
  émotionnels}
Ce pouvoir du cerveau a transformé nos capacités d'écoute en sélectionnant les informations nous interpelle au sujet des patients.
Qu'en est-il pour ceux  venus consulter en thérapie et en pleine
...
certains sons. En fait, il s'agit d'une \textbf{distorsion} dont nous reparlerons au chapitre 3.
...
\paragraph{ L'écoute dans le rapport
  ...
  sur la  formation \gls{réticulée} (Cf. Glossaire ),
  %%%(Cf. Glossaire)
...
des approches récentes. Damasio A. \autocite {damasio:lautre},
...
cités dans l'étude de Khalfa \autocite{affectiveDisorders}. Tous soulignent
...
dans la parole ou le chant.''}\footnote{Cf. Cours issu de la formation continue, avril 2012, Paris, J.P.Granier}
...
d'Hohewegg, Zürich.}. Propos appuyés d'ailleurs par \textbf{la neuroscience sociale} \autocite[201]{van_eersel_cerveau}, cette nouvelle discipline émergeant depuis
