...
\\
\textbf{Ecouter ou entendre : une différence}
...
\\
\emph{L'écoute} implique donc les notions de son et
...
Granier J.P., co-auteur de l'étude précédemment citée  (\citeyear{affectiveDisorders}),poursuit les travaux 
...
\begin{figure}[h]
	...
	\caption{Exemple d'audiométrie tonale, Amplifion SA, 2008}
\label{audiogramme}
\end{figure}

\paragraph{Les tests d'écoute en musicothérapie}:
\label{musicothEtpsycho}
les musicothérapeutes explorent l'alliage du son
 et de la psychologie, et inversément, les psychanalystes, les psychiatres, les psychologues
 s'intéressent à intégrer le son dans leur travail.
 Ainsi une élaboration se fait, porteuse d'informations différentes que
...
\begin{center}       
	\begin{figure}[h]
		...
		Verdeau-Paillès  \autocite [89] {lecourt_les_2017}.}
	\end{figure}	
\end{center}
...
et communication''.
%\subsection*
 \paragraph{Introduction générale:} dans le contexte d'étude des troubles de
