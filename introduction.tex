...
{{La musicothérapie est une pratique ancestrale. Il suffit de considérer la très grande  place de la musique dans les mythologies et dans les rites. \text Selon M.Schneider,\textit{\subparagraph{ \textsl{elle cherche à sauvegarder et à fortifier la pure substance sonore de l'homme."} }\footnote{M.Schneider," Le rôle de la musique dans la mythologie et les rites des civilisations non européennes", Histoire de la musique, tome I, Paris, Gallimard, Encyclopédie La Pléiade, 1960, pp.202-203} }
}
\paragraph{La musique, la matière sonore}est utilisée dans le but d'un "\textsl{processus
