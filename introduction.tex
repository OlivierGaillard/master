...
\begin{quotation}
\emph{<<\,\emph{ La musique vient dans la chair comme un produit immatériel
qui vient travailler la zone à soigner. (...)     }. [\dots] 
\textsl{ Je pompe de la
guérison. (...)
  Depuis le début des écoutes, j’ai la sensation physique et
psychique de la
transformation. (...)}
	\emph{  La musique est équilibrante et guérisseuse, ma zone
anesthésiée se remet à vivre, elle est remise en activité. (...) Il y
...
[\ldots] \emph{ Une patiente }''}\, \autocite[propos
d'une patiente]{}
\end{quotation}
...
aux tests réalisés, il pourrait être profitable
de recueillir quelques considérations et réflexions allant dans le sens de
notre hypothèse, celle de l'amélioration de l'écoute.
...
\section{Méthode d'intervention}
	...
	et un autre test, le WHOQO-Bref qui est qualitatif.
        ...
        Ce test d'écoute détecte la manière de recevoir l'information.
Avec celui-ci, nous obtiendrons des
