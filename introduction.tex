...
``l'\underline{\underline{harmonie}} se calculait" et pouvait être intégrée et infléchie dans la 
philosophie et les traités musicaux. [\dots] Les formes d'utilisation 
thérapeutique de la musique sont décrites dans un ``traité de politique", 
``Kitab as Siyasa" [\dots] et remontent à des documents syriens ou saabéens de la fin du 
