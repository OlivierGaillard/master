...
% \textbf{Total  des test d'écoute: 26}
 ...
 % et des entrevues (aussi lors du test d'écoute).
...
%audiométrique suivie du questionnaire qualitatif.
 ...
 %Avec le questionnaire 
  ...
  % comparatifs.
   ...
   % de cinq patients:  négatif:  $-$ et deux patients: positif:  $+$.
...
% , obtenant ainsi un comparatif avec 7 patients.
  %\\
...
le groupe de musicothérapie, donc 26 tests d'écoute dans l'ensemble.
 ...
 % \footnote Cette technique a été élaborée par l'auteure pour ce travail. 
 % Nous avons rajouté 
...
%\label{groupecontroleimage1}
      ...
      permanente vécue dans le milieu familial.
          ...
          résultats positifs du test: %correspondent à la possibilité de se retrouver dans un milieu clos et 
          %protégé lors ont été bénéfiques: 
